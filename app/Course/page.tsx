...
export default function page() {
  ...
  const metadata = {
    title: "คอร์สเรียนโฆษณาออนไลน์ ตลาด Google YouTube Facebook",
    description: "คอร์สเรียนโฆษณาออนไลน์ ผู้เชี่ยวชาญด้านการตลาดบน Google, YouTube และ Facebook",
...
<div className="text-center">
    <img src="assets/img/class.jpg" width="80%" alt="class" />
</div>
<hr />
<ul>
